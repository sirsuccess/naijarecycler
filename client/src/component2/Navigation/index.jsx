...
function Navigation() {
    return (
        <div>
                <Navbar bg="dark" expand="lg" className="nav-bg">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mr-auto ml-5">
                            <Nav.Link href="/" style={{color: "red", fontWeight: "bold", marginLeft: "1rem"}}>Home</Nav.Link>
                            ...
                            <Nav.Link href="/recycling"  style={{color: "grey", fontWeight: "bold", marginLeft: "1rem"}} className=" mr-5">Recycling</Nav.Link>
